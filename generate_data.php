<?php
 ...
 'Software bugs are hard to detect by anybody except may be
 the end user.',);

 $authors = array('Luke Skywalker', 'Leia Organa', 'Han Solo',
 'Darth Vader', 'Spock', 'James Kirk',
 ...
 $categories = array('Electronics', 'Mathematics', 'Programming',
 'Data Structures', 'Algorithms',
 'Computer Networking');

 $tags = array('programming', 'testing', 'webdesign', 'tutorial',
 'howto', 'version-control', 'nosql', 'algorithms',
 'engineering', 'software', 'hardware', 'security');
 ...
 $rating = mt_rand(1, 10);
 $publishedAt = new Mongodb\BSON\UTCDateTime(getRandomTimestamp());
